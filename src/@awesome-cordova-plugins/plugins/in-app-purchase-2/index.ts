 ...
 *  - **cordova-plugin-purchase** version 12 or lower. For versions 13 and higher, use plugin InAppPurchase3 instead
 * @see https://github.com/j3k0/cordova-plugin-purchase/wiki/HOWTO:-Migrate-to-v13
 * @usage
 * ```typescript
